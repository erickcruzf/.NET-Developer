...
namespace Alura.Loja.Testes.ConsoleApp
{
    class Program
    {
        ...
        private static void IncluirPromocao()
        {
            using (var contexto = new LojaContext())
            {
                ...
                var produtos = contexto
                    .Produtos
                    .Where(p => p.Categoria == "Bebidas") // Seleciona os produtos da categoria bebidas.
                    .ToList();
        ...
        private static void MuitosParaMuitos()
        {
            ...
            var p2 = new Produto() { Nome = "Café", Categoria = "Bebidas", PrecoUnitario = 12.00, Unidade = "Gramas" };
            var p3 = new Produto() { Nome = "Macarrão", Categoria = "Alimentos", PrecoUnitario = 6.40, Unidade = "Kilos" };
